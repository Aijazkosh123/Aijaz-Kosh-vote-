...
export default function App() {
  ...
  // Authenticate user on mount - DUMMY MODE
  useEffect(() => {
    ...
    setAppLoading(false); // API call hata di
  }, []);
  ...
  // Refresh balance - DUMMY
  const handleRefreshBalance = async () => {
    console.log("Dummy refresh - backend nahi hai abhi")
  };

  if (appLoading) {
    return (
      <div id="app-loading-screen" className="min-h-screen bg-[#030712] text-slate-100 flex-col items-center justify-center p-4">
